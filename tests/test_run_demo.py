...
def test_high_risk_starts_screening_no_later_than_low_risk():
...
def test_high_risk_screens_at_least_as_much_as_low_risk():
    low_pomdp = build_pomdp("low")
    high_pomdp = build_pomdp("high")
    low_stages = solve(low_pomdp, HORIZON)
    high_stages = solve(high_pomdp, HORIZON)
...
def test_high_risk_screens_at_some_point():
